...
bool AndroidShareUtils::checkMimeTypeView(const QString &mimeType) {
  ...
  jboolean verified = QJniObject::callStaticMethod<jboolean>(
      "org/nshcherbakova/utils/QShareUtils", "checkMimeTypeView",
...
void AndroidShareUtils::sendFile(const QString &filePath, const QString &title,
  ...
  jboolean ok = QJniObject::callStaticMethod<jboolean>(
      "org/nshcherbakova/utils/QShareUtils", "sendFile",
...
Java_org_nshcherbakova_activity_QShareActivity_setFileUrlReceived(JNIEnv *env,
                                                                  jobject,
                                                                  jstring url) {
...
Java_org_nshcherbakova_activity_QShareActivity_checkFileExits(JNIEnv *env,
                                                              jobject,
                                                              jstring url) {
  const char *urlStr = env->GetStringUTFChars(url, nullptr);
  bool exists =
...
JNIEXPORT void JNICALL
Java_org_nshcherbakova_activity_QShareActivity_fireActivityResult(
